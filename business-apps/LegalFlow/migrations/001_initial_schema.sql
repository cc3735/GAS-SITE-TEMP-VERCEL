...
-- =====================================================
-- The handle_new_user function and trigger have been removed as they are not working as expected.
-- The user profile is now created directly in the /signup route.
