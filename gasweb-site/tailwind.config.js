/**
 * Tailwind CSS Configuration for GasWeb.info
 * 
 * Professional, semi-technical design system targeting small business owners.
 * Color scheme emphasizes trust, innovation, and professionalism.
 */
...
export default {
  ...
  theme: {
    extend: {
       ...
       * - Secondary: Cyan/teal for innovation and technology
      ...
      /**
       * Typography
       * Using Inter as the primary font for readability
       * Playfair Display for headings to add sophistication
       */
      fontFamily: {
