    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 rounded-xl max-w-4xl w-full p-6 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2">Estimated Time of Completion</label>
            <select
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Cost to Operate ($)</label>
              <input
                type="number"
                min="0"
                step="0.01"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">GAS Fee ($)</label>
              <input
                type="number"
                min="0"
                step="0.01"
