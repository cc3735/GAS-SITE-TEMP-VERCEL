      ...
      <div className="bg-gray-900 rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="flex h-[calc(90vh-120px)]">
          ...
          <div className="w-80 border-r border-gray-700 p-6">
            <h3 className="font-semibold text-white mb-4">Creation Method</h3>
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-white">Wizard Setup</div>
                    <div className="text-sm text-gray-400">Step-by-step configuration</div>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-white">JSON Config</div>
                    <div className="text-sm text-gray-400">Import agent configuration</div>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-white">n8n Integration</div>
                    <div className="text-sm text-gray-400">Connect workflow automation</div>
                  </div>
                </div>
              </button>
            </div>
          ...
          <div className="flex-1 p-6 overflow-y-auto">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none resize-none bg-gray-800 text-white placeholder-gray-500"
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {config.referenceLinks.map(link => (
                      <div key={link.id} className="flex items-center justify-between p-3 bg-gray-950 rounded-lg">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            <Link className="w-4 h-4 text-blue-400 flex-shrink-0" />
                            <a href={link.url} target="_blank" rel="noopener noreferrer" className="font-medium text-blue-400 hover:underline truncate">
                              {link.title}
                            </a>
                          </div>
                          {link.description && (
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {config.uploadedFiles.map(file => (
                      <div key={file.id} className="flex items-center justify-between p-3 bg-gray-950 rounded-lg">
                        <div className="flex items-center gap-3">
            ...
            {creationMethod === 'json' && (
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-white mb-4">Import JSON Configuration</h3>
            ...
            {creationMethod === 'n8n' && (
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-white mb-4">Connect to n8n Workflow</h3>
                  <p className="text-sm text-gray-400 mb-4">
        ...
        {/* Footer */}
        <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-700 bg-gray-950 rounded-b-xl">
          <button
            onClick={() => {
              onClose();
              resetForm();
          ...
          <button
            ...
            className="px-6 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Create Agent
          </button>
        </div>
