              ...
              >
                <Icon
                  className={`-ml-0.5 mr-2 h-5 w-5 ${
                    activeTab === tab.id ? 'text-primary-400' : 'text-gray-400 group-hover:text-gray-500'
                  }`}
                />
                {tab.name}
              </button>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-gray-900 rounded-xl border border-gray-700 p-6">
              ...
              <h3 className="text-sm font-medium text-gray-400 mb-1">Total Recipients</h3>
              <p className="text-3xl font-bold text-white mb-2">15,247</p>
            ...
            <div className="bg-gray-900 rounded-xl border border-gray-700 p-6">
              ...
              <h3 className="text-sm font-medium text-gray-400 mb-1">Average Open Rate</h3>
              <p className="text-3xl font-bold text-white mb-2">24.6%</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-gray-900 rounded-xl border border-gray-700 p-6">
              ...
              <h3 className="text-sm font-medium text-gray-400 mb-1">Posts This Week</h3>
            ...
            <div className="bg-gray-900 rounded-xl border border-gray-700 p-6">
              ...
              <h3 className="text-sm font-medium text-gray-400 mb-1">Active Accounts</h3>
            ...
            <div className="bg-gray-900 rounded-xl border border-gray-700 p-6">
              ...
              <h3 className="text-sm font-medium text-gray-400 mb-1">Scheduled Posts</h3>
            ...
            <div className="bg-gray-900 rounded-xl border border-gray-700 p-6">
              ...
              <h3 className="text-sm font-medium text-gray-400 mb-1">Avg. Engagement</h3>
              <p className="text-3xl font-bold text-white mb-2">14.7%</p>
