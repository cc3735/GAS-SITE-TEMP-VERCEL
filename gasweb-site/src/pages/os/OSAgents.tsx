    ...
    <div className="p-6 lg:p-8">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold text-white">AI Agents & Coding</h1>
        </div>
        {activeTab === 'agents' && (
          <button
              ...
              <div className="bg-gray-800 rounded-lg border border-gray-700 p-4 hover:border-gray-600 transition">
                ...
                <div className="flex items-center justify-between text-xs text-gray-500">
                  ...
                  <div className="flex gap-1">
                    <button className="text-primary-400 hover:text-blue-300 p-1" title="View Code">
                      <Eye className="w-3 h-3" />
                    </button>
                    <button className="text-primary-400 hover:text-blue-300 p-1" title="Copy Code">
